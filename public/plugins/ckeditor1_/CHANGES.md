...
* [#8031](http://dev.ckeditor.com/ticket/8031): Handle `required` attributes on `<textarea style="text-transform:uppercase" class="form-control">` elements &mdash; introduced [editor#required](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-required) event.
* [#10280](http://dev.ckeditor.com/ticket/10280): Ability to replace `<textarea style="text-transform:uppercase" class="form-control">` elements with the inline editor.
