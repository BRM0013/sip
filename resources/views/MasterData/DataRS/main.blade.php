...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Master Pengguna RS / Fasyankes</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Master Data</a></li>
      <li class="active"> Master Data Rumah Sakit</li>
    </ol>
  </section>
  <section class="content">
      <div class="box box-info" id="btn-add" style="border-top:none">
        <h4 style="padding: 10px;margin:0px;color:#fff;font-weight: 600;background: #b6d1f2; text-shadow: 0 1px 0 #aecef4;">
          <i class="fa fa-file iconLabel m-r-15"></i> Data Rumah Sakit / Fasyankes
        </h4>
      <div class="box-body">
        <div class="col-md-12">
         {{-- DATA GRID --}}
            <div class="col-md-12 form-inline main-layer panelSearch p-10">
              <div class="form-group pull-left">
                <a class="btn btn-warning" href="{{ route('add_data_rs') }}">
...
@section('js')
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      get_load('{{ route('datagrid_data_rs') }}');
    });
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="{{ url("/") }}/home/master/data_rs/edit/'+rowData.id+'"><i class="fa fa-pencil"></i> Edit</a></li>';
    ...
    function deletes(id) {
      swal({
       ...
       function(){
         $.post("{{route('delete_data_rs')}}", {id:id}).done(function(data){
