...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Master Fasyankes</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Master Data</a></li>
      <li class="active"> Master Fasyankes</li>
    </ol>
  </section>
  <section class="content">
      <div class="box box-info" id="btn-add" style="border-top:none">
        <h4 style="padding: 10px;margin:0px;color:#fff;font-weight: 600;background: #b6d1f2; text-shadow: 0 1px 0 #aecef4;">
          <i class="fa fa-file iconLabel m-r-15"></i> Data Fasyankes
        </h4>
      <div class="box-body">
        <div class="col-md-12">
         {{-- DATA GRID --}}
  ...
  <script type="text/javascript">
    ...
    function get_load(url) {
      $("#datagrid").html('');
        ...
        columns                 : [
          {field: 'nama', title: 'Nama Fasyankes', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'alamat', title: 'Alamat', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'kelas', title: 'Kelas', editable: false, sortable: true, width: 200, align: 'left', search: true},
    ...
    $(document).ready(function() {
      get_load('{{ route('datagrid_fasyankes') }}');
    });
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="javascript:void(0);" onclick="formInput(\''+rowData.id_fasyankes+'\')"><i class="fa fa-pencil"></i> Edit</a></li>';
      html +=     '<li><a href="javascript:void(0);" onclick="deletes(\''+rowData.id_fasyankes+'\')"><i class="fa fa-trash-o"></i> Delete</a></li>' +
                '</ul>' +
              '</div>';
      return html;
    }
    ...
    function formInput(id){
      $.post("{!! route('add_fasyankes') !!}", {id:id}).done(function(data){
    ...
    function deletes(id) {
      swal({
       ...
       function(){
         $.post("{{route('delete_fasyankes')}}", {id:id}).done(function(data){
           if(data.status == 'success'){
             datagrid.reload();
