<?php
  ...
  if (isset($jpraktik)) {
    $id_jenis_praktik        = $jpraktik->id_jenis_praktik;
    $nama_jenis_praktik      = $jpraktik->nama_jenis_praktik;
  }
?>
                  ...
                  <div class="box" style="border-top:none">
                    <div class="col-md-13">
                      ...
                      <h4 style="padding: 10px;margin:0px;color:#fff;font-weight: 600;background: #b6d1f2; text-shadow: 0 1px 0 #aecef4;">
                        ...
                        <div class="box-body">
                          <div class="col-md-12">
                            <form action="{{ route('save_jenis_praktik') }}" method="post" enctype="multipart/form-data">
                             @csrf
                             <input type="hidden" name="id_jenis_praktik" value="{{ $id_jenis_praktik }}">
                            <div class="row">
                              <div class="col-md-12">
                                
                                <div class="form-group">
                                  <label class="col-sm-12 control-label">Nama Jenis Praktik</label>
                                  <div class="col-sm-12">
                                    <input type="text" required name="nama_jenis_praktik" value="{{ $nama_jenis_praktik }}" class="form-control" placeholder="Tulis praktik baru...">
                                  </div>
                                </div>
