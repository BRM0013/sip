...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Master Jenis Sarana</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Master Data</a></li>
      <li class="active"> Master Jenis Sarana</li>
    </ol>
  </section>
  ...
  <script type="text/javascript">
    ...
    function get_load(url) {
      $("#datagrid").html('');
        ...
        columns                 : [
          {field: 'nama_sarana', title: 'Nama Sarana', editable: false, sortable: true, width: 200, align: 'left', search: true},
    ...
    $(document).ready(function() {
      get_load('{{ route('datagrid_jenis_sarana') }}');
    });
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="javascript:void(0);" onclick="formInput(\''+rowData.id_jenis_sarana+'\')"><i class="fa fa-pencil"></i> Edit</a></li>';
      html +=     '<li><a href="javascript:void(0);" onclick="deletes(\''+rowData.id_jenis_sarana+'\')"><i class="fa fa-trash-o"></i> Delete</a></li>' +
                '</ul>' +
              '</div>';
      return html;
    }
    ...
    function formInput(id){
      $.post("{!! route('add_jenis_sarana') !!}", {id:id}).done(function(data){
    ...
    function deletes(id) {
      swal({
       ...
       function(){
         $.post("{{route('delete_jenis_sarana')}}", {id:id}).done(function(data){
           if(data.status == 'success'){
             datagrid.reload();
