  ...
  <script type="text/javascript">
    ...
    function get_load(url) {
      ...
      var datagrid = $("#datagrid").datagrid({
        ...
        columns                 : [
          {field: 'id_desa', title: 'Kode Desa', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'nama_provinsi', title: 'Nama Provinsi', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'nama_kabupaten', title: 'Nama Kabupaten', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'nama_kecamatan', title: 'Nama Kecamatan', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'nama_desa', title: 'Nama Desa', editable: false, sortable: true, width: 200, align: 'left', search: true},
    ...
    $(document).ready(function() {
      get_load('{{ route('datagrid_master_desa') }}');
    });
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="javascript:void(0);" onclick="formInput(\''+rowData.id_desa+'\')"><i class="fa fa-pencil"></i> Edit</a></li>';
      // html +=     '<li><a href="javascript:void(0);" onclick="deletes(\''+rowData.id_desa+'\')"><i class="fa fa-trash-o"></i> Delete</a></li>' +
                '</ul>' +
              '</div>';
      return html;
    }
    ...
    function formInput(id){
      $.post("{!! route('add_desa') !!}", {id:id}).done(function(data){
