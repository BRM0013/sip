...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Master Pendidikan Terakhir</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Master Data</a></li>
      <li class="active"> Master Pendidikan Terakhir</li>
    </ol>
  </section>
  ...
  <script type="text/javascript">
    ...
    function get_load(url) {
      $("#datagrid").html('');
        ...
        url                     : url,
        primaryField            : 'id_pendidikan_terakhir',
        rowNumber               : true,
        rowCheck                : false,
        ...
        columns                 : [
          {field: 'pendidikan_terakhir', title: 'Pendidikan Terakhir', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'jenjang', title: 'Jenjang', editable: false, sortable: true, width: 200, align: 'left', search: true},
    ...
    $(document).ready(function() {
      get_load('{{ route('datagrid_pendidikan_terakhir') }}');
    });
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="javascript:void(0);" onclick="formInput(\''+rowData.id_pendidikan_terakhir+'\')"><i class="fa fa-pencil"></i> Edit</a></li>';
      html +=     '<li><a href="javascript:void(0);" onclick="deletes(\''+rowData.id_pendidikan_terakhir+'\')"><i class="fa fa-trash-o"></i> Delete</a></li>' +
                '</ul>' +
              '</div>';
      return html;
    }
    ...
    function formInput(id){
      $.post("{!! route('add_pendidikan_terakhir') !!}", {id:id}).done(function(data){
    ...
    function deletes(id) {
      swal({
       ...
       function(){
         $.post("{{route('delete_pendidikan_terakhir')}}", {id:id}).done(function(data){
           if(data.status == 'success'){
             datagrid.reload();
