...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Master Jenis Persyaratan</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Master Data</a></li>
      <li class="active"> Master Jenis Persyaratan</li>
    </ol>
  </section>
  ...
  <script type="text/javascript">
    ...
    function get_load(url) {
      $("#datagrid").html('');
        ...
        url                     : url,
        primaryField            : 'id_jenis_persyaratan',
        rowNumber               : true,
        rowCheck                : false,
        ...
        columns                 : [
          {field: 'nama_jenis_persyaratan', title: 'Judul Jenis Persyaratan', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'nama_variable', title: 'Nama Varibale', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'jenis_input', title: 'Jenis Input', editable: false, sortable: true, width: 200, align: 'left', search: true},
          {field: 'keterangan_persyaratan', title: 'Keterangan', editable: false, sortable: true, width: 200, align: 'left', search: true},
    ...
    $(document).ready(function() {
      get_load('{{ route('datagrid_jenis_persyaratan') }}');
    });
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="javascript:void(0);" onclick="formInput(\''+rowData.id_jenis_persyaratan+'\')"><i class="fa fa-pencil"></i> Edit</a></li>';
      html +=     '<li><a href="javascript:void(0);" onclick="deletes(\''+rowData.id_jenis_persyaratan+'\')"><i class="fa fa-trash-o"></i> Delete</a></li>' +
                '</ul>' +
              '</div>';
      return html;
    }
    ...
    function formInput(id){
      $.post("{!! route('add_jenis_persyaratan') !!}", {id:id}).done(function(data){
    ...
    function deletes(id) {
      swal({
       ...
       function(){
         $.post("{{route('delete_jenis_persyaratan')}}", {id:id}).done(function(data){
           if(data.status == 'success'){
             datagrid.reload();
