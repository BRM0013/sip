...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"> Master Jenis Surat</li>
         ...
         {{-- DATA GRID --}}
            ...
            <div class="col-md-12 form-inline main-layer panelSearch p-10">
              ...
              <div class="form-group pull-left">
                ...
                <a class="btn btn-warning" href="{{ route('add_jenis_surat') }}">
...
@section('js')
  ...
  <script type="text/javascript">
    ...
    function get_load(url) {
      ...
      $("#datagrid").html('');
        ...
        columns                 : [
          ...
          {field: 'nama_surat', title: 'Jenis Surat', editable: false, sortable: true, width: 200, align: 'left', search: true},

          {field: 'maksimal_pengajuan', title: 'Maksimal Pengajuan', editable: false, sortable: true, width: 200, align: 'left', search: true},

          {field: 'format_str', title: 'Format STR', editable: false, sortable: true, width: 200, align: 'left', search: true},
    ...
    $(document).ready(function() {
      ...
      get_load('{{ route('datagrid_jenis_surat') }}');
    ...
    function menu(rowData,rowIndex){
      ...
      html +=     '<li><a href="{{ url("/")}}/home/master/jenis_surat/edit/'+rowData.id_jenis_surat+'"><i class="fa fa-pencil"></i> Edit</a></li>';

      

      if (rowData.id_jenis_surat != 28) {

        // html +=     '<li><a href="javascript:void(0);" onclick="deletes(\''+rowData.id_jenis_surat+'\')"><i class="fa fa-trash-o"></i> Delete</a></li>';
    ...
    function deletes(id) {
      ...
      swal({
       ...
       function(){
         ...
         $.post("{{route('delete_jenis_surat')}}", {id:id}).done(function(data){
