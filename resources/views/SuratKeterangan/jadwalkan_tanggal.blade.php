  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header" style="background: #b6d1f2; text-shadow: 0 1px 0 #aecef4">
        ...
        <h4 class="modal-title" id="product-detail-dialog" style="color: #fff; font-size: 18px; font-weight: 600;"><i class="fa fa-user m-r-15 m-l-5"></i> FORM JADWALKAN TANGGAL </h4>
      </div>
      <div class="modal-body">
        <form class="form-save">
          @foreach($id as $val)
          <input type="hidden" name="id_surat_keterangan[]" value="{{$val}}">
          @endforeach
          ...
          <div class="form-group">
            ...
            <textarea name="jadwal_keterangan" class="form-control"></textarea>
          </div>
        </form>
      </div>
...
<script type="text/javascript">
  ...
  $('.btn-submit').click(function(e){
   ...
   console.log(data);
   $.ajax({
     url: "{{ route('simpanJadwalkanTanggalSuket') }}",
     type: 'POST',
     data: data,
     async: true,
     cache: false,
