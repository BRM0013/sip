...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-info" id="btn-add" style="border-top:none">
                <h4
                    style="padding: 10px;margin:0px;color:#fff;font-weight: 600;background: #b6d1f2; text-shadow: 0 1px 0 #aecef4;">
                    <i class="fa fa-plus-square iconLabel m-r-15"></i> Formulir Pengajuan {{ $jenis_surat->nama_surat }}
                </h4>
                <form class="form-save">
                    ...
                    <div class="box-body">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <div class="form-group" style="margin: 0px;">
                                ...
                                <input readonly type="text" class="form-control input-sm"
                                    value="{{ $users->jenis_kelamin }}" style="text-transform:uppercase">
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>

                            <div class="form-group" style="margin: 0px;">
                                <label>Alamat Rumah (Sesuai KTP)<span class="colorRed">*</span></label>
                                <textarea style="text-transform:uppercase" class="form-control" style="text-transform: lowercase;" class="form-control"
                                    readonly>{{ $users->alamat_jalan_rt_rw }}, {{ $users->desa->nama_desa }}, {{ $users->kecamatan->nama_kecamatan }}, {{ $users->kabupaten->nama_kabupaten }}, {{ $users->provinsi->nama_provinsi }}</textarea>
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                        ...
                        <div class="col-md-6 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group" style="margin: 0px;">
                                            ...
                                            <input type="text"name="sip_ke" class="form-control input-sm "
                                                value="{{ $sip_ke }}" onkeyup="return cekAngka(event)"
                                                maxlength="1" id="pilihan">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group" style="margin: 0px;">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin: 0px;">
                                            <label>Tahun Ijazah <span class="colorRed">*</span></label>
                                            <input type="text" style="text-transform:uppercase" name="tanggal_ijazah"
                                                class="form-control input-sm" id="datepicker2"
                                                class="form-control input-sm datepicker-custom"
                                                placeholder="Tanggal Ijazah Keluar">
                                            <small style="font-weight: 900; color: red;">*Format Inputan : Tahun - Bulan -
                                                Tanggal.</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group" style="margin: 0px;">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text"name="nomor_str" class="form-control input-sm "
                                            value="<?php if ($perpanjangan != '/perpanjangan') {
                                                echo $nomor_str;
                                            } ?>" style="text-transform:uppercase"
                                            onkeypress="return cekAngkaHuruf(event)">
                                    </div>
                                    <div class="col-sm-12">
                                        <label>Masa Berlaku SIP <span class="colorRed">*</span></label>
                                        <br><Input type = 'Radio' Name ='target' value= 'r1' id="enable"
                                            <?php echo $rdenable; ?>>STR SEUMUR HIDUP
                                        <br><Input type = 'Radio' Name ='target' value= 'r2' id="disable"
                                            <?php echo $rddisable; ?>>STR MEMILIKI MASA BERLAKU
                                        <input style="display: <?php echo $berlaku_disable; ?>;" type="text"
                                            style="text-transform:uppercase" name="tanggal_berlaku_str"
                                            value="<?php if ($perpanjangan != '/perpanjangan') {
                                                echo $tanggal_berlaku_str;
                                            } ?>" class="form-control input-sm" id="datepicker"
                                            placeholder="Tanggal STR">
                                        <small style="font-weight: 900; color: red;">*Format Inputan : Tahun - Bulan -
                                            Tanggal.</small>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6" id="panel1">
                                        <div class="form-group" style="margin: 0px;">
                                            ...
                                            <input type="file" name="sip_1" id="sip_1"
                                                class="form-control input-sm" accept="image/*,.pdf">
                                            <span id="info-file-sip_1" style="color:red; display:none;">File yang anda
                                                masukan lebih dari 2MB</span>
                                            @if (isset($surat))
                                                @if ($surat->sip_1 != '')
                                                    @if (file_exists('uploads/file_berkas/' . $surat->sip_1))
                                                        <button type="button" class="btn btn-success btn-sm"
                                                            data-toggle="modal" data-target="#myModal"
                                                            onclick="modal_sip('Sip 1','{{ $surat->sip_1 }}')">FIle
                                                            terlampir</button>
                                  ...
                                  <img src="{{ url('uploads/file_berkas/' . $surat->sip_1) }}" style="width: 100%">
                                    ...
                                    <div class="col-sm-6" id="panel2">
                                        <div class="form-group" style="margin: 0px;">
                                            ...
                                            <input type="file" name="sip_2" id="sip_2"
                                                class="form-control input-sm" accept="image/*,.pdf">
                                            <span id="info-file-sip_2" style="color:red; display:none;">File yang anda
                                                masukan lebih dari 2MB</span>
                                            @if (isset($surat))
                                                @if ($surat->sip_2 != '')
                                                    @if (file_exists('uploads/file_berkas/' . $surat->sip_2))
                                                        <button type="button" class="btn btn-success btn-sm"
                                                            data-toggle="modal" data-target="#myModal"
                                                            onclick="modal_sip('Sip 2','{{ $surat->sip_2 }}')">File
                                                            terlampir</button>
                            ...
                            <!--<div class="form-group" style="margin: 0px;">
                    <label>Perolehan STR<span class="colorRed">*</span></label>
                        <select name="perolehan_str" class="form-control" id="perolehan_str">
                                <option value="Tanpa Kecukupan SKP">Tanpa Kecukupan SKP</option>
                                 <option value="Dengan Kecukupan SKP">Dengan Kecukupan SKP</option>
                            </select>
                  </div>
                  <div class="clearfix" style="margin-bottom: 10px;"></div>-->
                    ...
                    <input type="text"name="sebagai_jabatan" class="form-control input-sm " value="& if ($perpanjangan != '/perpanjangan'){ echo $sebagai_jabatan; } ?>" style="text-transform:uppercase" onkeypress="return cekAngkaHuruf(event)">
                  </div>
                  <div class="clearfix" style="margin-bottom: 10px;"></div>-->

                            <div class="form-group" style="margin: 0px;">
                                <label>Profesi<span class="colorRed">*</span></label>
                                <input readonly type="text" name="profesi" class="form-control input-sm"
                                    value="{{ $users->profesi }}">
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>

                            @if (
                                $users->id_jenis_surat == 7 ||
                                    $users->id_jenis_surat == 8 ||
                                    $users->id_jenis_surat == 14 ||
                                    $users->id_jenis_surat == 24)
                                <div class="form-group" style="margin: 0px;">
                                    <label>Jenis Praktik<span class="colorRed">*</span></label>
                                    <input type="text"name="keterangan_jenis_praktik" class="form-control input-sm "
                                        value="{{ $keterangan_jenis_praktik }}" style="text-transform:uppercase"
                                        placeholder="Tambahkan Jenis Praktik" onkeypress="return cekAngkaHuruf(event)">
                                </div>
                                <div class="clearfix" style="margin-bottom: 10px;"></div>
                            @endif
                            ...
                            <div class="form-group" style="margin: 0px;">
                                <label>Jenis Praktik<span class="colorRed">*</span></label>
                                <select name="jenis_praktik" id="jenis_praktik" class="form-control"
                                    onchange="toggleJenisSarana(this)">
                                    <?php foreach ($list_ts_praktik as $row): ?>
                                    <option <?php if ($row->id_jenis_praktik == $id_jenis_praktik) {
                                        echo "selected='selected'";
                                    } ?> value="{{ $row->id_jenis_praktik }}">
                                        {{ $row->nama_jenis_praktik }}</option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                            <?php }else{ ?>
                            <input type="hidden" name="jenis_praktik"
                                value="{{ $list_ts_praktik[0]->id_jenis_praktik }}">
                            <?php } ?>




                            <div class="form-group" id="jenis_sarana"
                                style="margin: 0px; <?= $id_jenis_praktik == 3 ? 'display: none;' : '' ?>">
                                ...
                                <select name="jenis_sarana" class="form-control" style="text-transform: uppercase">
                                    ...
                                    <option <?php if ($row->id_jenis_sarana == $id_jenis_sarana) {
                                        echo "selected='selected'";
                                    } ?> value="<?= $row->id_jenis_sarana ?>">
                                        <?= $row->nama_sarana ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                            ...
                            <!-- <div class="form-group" style="margin: 0px;">
                    <label>Nomor Surat Pernyataan Kecukupan SKP (Kosongi Jika Tidak Ada)</label>
                    <input type="text"name="nomor_op" class="form-control input-sm " value="<?php if ($perpanjangan != '/perpanjangan') {
                        echo $nomor_op;
                    } ?>" style="text-transform:uppercase" onkeypress="return cekAngkaHuruf(event)">
                  </div>
                  <div class="clearfix" style="margin-bottom: 10px;"></div>-->

                            <div class="form-group" style="margin: 0px;">
                                <label>Nama Tempat Praktik (Khusus Praktek Mandiri diisi PRAKTEK PERSEORANGAN)<span
                                        class="colorRed">*</span></label>
                                <input type="text" name="nama_tempat_praktik" id="nama_tempat_praktik"
                                    class="form-control input-sm"
                                    value="<?= isset($nama_tempat_praktik) ? $nama_tempat_praktik : '' ?>"
                                    style="text-transform:uppercase" onkeypress="return cekAngkaHuruf(event)">
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                            ...
                            <div class="form-group" style="margin: 0px;">
                                ...
                                <input type="text"name="alamat_tempat_praktik" class="form-control input-sm "
                                    value="{{ $alamat_tempat_praktik }}" style="text-transform:uppercase"
                                    onkeypress="return cekAngkaHuruf(event)">
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                  ...
                  <div class="clearfix" style="margin-bottom: 10px;"></div>            -->
                            ...
                            <div class="form-group" style="margin: 0px;">
                                            ...
                                            <td class="to_text_shift" id="td_hari_0" colspan="2">
                                                <div class="row">
                                                    <div style="margin-left: 30px;" class="col-sm-10">
                                                        <input id="input_hari_0" type="text" name=""
                                                            class="form-control to_text_shift "
                                                            placeholder="Senin s.d Sabtu">
                                                    </div>
                                                    <div style="padding-left: 0px;" class="col-sm-1">
                                                        <a href="javascript:void(0)"
                                                            onclick="remove_waktu_praktik_shift('tr_hari_shift_0')"
                                                            style="width: 39px;" class="btn btn-warning"><i
                                            ...
                                            <td class="to_text_shift" id="td_jam_shift_0_1">
                                                <div class="row">
                                                    <div style="padding-right: 0px;" class="col-sm-10">
                                                        <input id="input_jam_shift_0_1" type="text" name=""
                                                            class="form-control to_text_shift "
                                                            placeholder="07.00 - 14.00">
                                                    </div>
                                                    <div class="remove_add_shift" style="padding: 0px;" class="col-sm-1">
                                                        <a href="javascript:void(0)"
                                                            onclick="add_waktu_praktik_shift_kolom(1, '0')"
                                                            style="margin-left: 16px;" class="btn btn-success"><i
                                ...
                                <a href="javascript:void(0)" onclick="add_waktu_praktik_shift()"
                                    style="margin-top: 20px;" class="form-control btn btn-primary">Tambah Hari Kerja</a>
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                            <?php endif ?>
                            ...
                            <div class="form-group" style="margin: 0px;">
                                ...
                                <div id="waktu_praktik">
                                    ...
                                    <table id="table_waktu_praktik" style="width: 100%;">
                                        ...
                                        <tr id="tr_waktu_praktik_0">
                                            <td class="to_text" id="td_hari_0"><input id="input_hari_0" type="text"
                                                    name="" class="form-control to_text"
                                                    placeholder="Senin s.d Sabtu"></td>
                                            <td class="to_text" id="td_jam_0">
                                                <div class="row">
                                                    <div style="padding-right: 0px;" class="col-sm-10">
                                                        <input id="input_jam_0" type="text" name=""
                                                            class="form-control to_text" placeholder="07.00 - 14.00">
                                                    </div>
                                                    <div style="padding-left: 0px;" class="col-sm-1">
                                                        <a href="javascript:void(0)"
                                                            onclick="remove_waktu_praktik('tr_waktu_praktik_0')"
                                ...
                                <a href="javascript:void(0)" onclick="add_waktu_praktik()" style="margin-top: 20px;"
                                    class="form-control btn btn-primary">Tambah Hari Kerja</a>
                            </div>
                            <div class="clearfix" style="margin-bottom: 10px;"></div>
                            <?php endif ?>
                        </div>
                        ...
                        <div class="col-md-15">
                            <div class="form-group">
                                <label class="col-sm-12 control-label">
                                    <!--<?php echo $no++; ?>.-->
                                    <?php echo $berkas_persyaratan[$i]->nama_jenis_persyaratan; ?>
                                    <span class="colorRed">* </span></br>
                                </label>
                                <div class="col-sm-12">
                                    <input <?php if (empty($surat) || $perpanjangan == '/perpanjangan'); ?> style="border: solid 1px #d2d6de; padding: 5px;"
                                        accept="<?php echo $berkas_persyaratan[$i]->jenis_input; ?>" type="file"
                                        onchange="checkSize('<?php echo str_replace('/', '', $berkas_persyaratan[$i]->nama_variable); ?>')" id="<?php echo str_replace('/', '', $berkas_persyaratan[$i]->nama_variable); ?>"
                                        name="<?php echo $berkas_persyaratan[$i]->nama_variable; ?>" class="form-control input-sm input-berkas-pengajuan">
                                    <span class="colorRed">*Extensions : PDF / JPG / JPEG / PNG</span>
                                    <span class="colorRed">*Max Ukuran File 2MB</span>
                                    <span id="info-file-<?php echo str_replace('/', '', $berkas_persyaratan[$i]->nama_variable); ?>" style="color:red; display:none;">File yang
                                        anda masukan lebih dari 2MB</span>
                    ...
                    <div class="box-footer">
                        <div class="form-group" style="float: left;">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="status_simpan" value="Simpan"
                                    id="invalidCheck2">
                                <label class="form-check-label" for="invalidCheck2">
                                    Dengan menekan tombol <b style="color: red;">*Ajukan Permohonan </b> anda harus mengisi
                                    semua kolom dengan <b style=" color :red">* (Bintang)</b>.
                                </label>
                                </br>
                                <label class="form-check-label">
                                    NB : Tekan tombol <b style="color: red;">*Draf </b> jika permohonan anda belum terisi
                                    semua.
                                </label>
                            </div>
                        </div>
                        ...
                        <?php if ($jenis_surat->jenis_waktu_praktik == 'Waktu Praktik'): ?>
                        <button id="button-submit-sip" type="button" onclick="remove_input_waktu_praktik()"
                            class="btn btn-primary pull-right btn-simpan" data-btn="preview"
                            style="margin-left: 15px;">Ajukan Permohonan
                            <span style="margin-left: 5px;" class="fa fa-save"></span>
                        </button>
                        &nbsp;
                        <button id="button-submit-draf" type="button" class="btn btn-success pull-right btn-draf"
                            data-btn="draf" style="margin-left: 15px;">Draf
                            <span style="margin-left: 5px;" class="fa fa-save"></span>
                        </button>

                        <?php elseif ($jenis_surat->jenis_waktu_praktik == 'Waktu Praktik dengan Shift'): ?>
                        <button id="button-submit-sip" type="button" onclick="remove_input_waktu_praktik_shift()"
                            class="btn btn-primary pull-right btn-simpan" data-btn="preview"
                            style="margin-left: 15px;">Ajukan Permohonan
                            <span style="margin-left: 5px;" class="fa fa-save"></span>
                        </button>
                        ...
                        <button id="button-submit-sip" type="button" class="btn btn-primary pull-right btn-simpan"
                            data-btn="preview" style="margin-left: 15px;">Ajukan Permohonan
                      ...
                      <span style="margin-left: 5px;" class="fa fa-save"></span>
                        ...
                        <?php endif ?>
                        <a href="@if (isset($surat)) {{ route('surat') }}/list/{{ $surat->id_jenis_surat }}@else{{ route('surat') }} @endif"
                            class="btn btn-warning btn-cencel pull-right">
    ...
    <!-- Modal Preview SIP -->
    <div class="modal fade" id="modal-body-preview" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                <div class="modal-header" style="background: #b6d1f2; text-shadow: 0 1px 0 #aecef4">
                    ...
                    <h4 class="modal-title" id="product-detail-dialog"
                        style="color: #fff; font-size: 18px; font-weight: 600;"><i class="fa fa-file m-r-15 m-l-5"></i>
                        Preview SIP</h4>
                </div>
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //     return 'Sure?';
            // };
            var namaTempatPraktik = "<?php echo $nama_tempat_praktik; ?>";
            if (namaTempatPraktik == "") {
                var namaPengguna = '<?= Auth::user()->name ?>';
                $('#nama_tempat_praktik').val(namaPengguna);
            }
            ...
            $('#modal-body-preview').on('hidden.bs.modal', function() {
                ...
                $.post("{{ route('del_file_berkas') }}", {
                    id_surat_preview: id_surat_preview
                }).done(function(data) {
            ...
            $('#datepicker2').datepicker({
                ...
                yearRange: '1950:2100' // Specify the range of years
            });
        ...
        function cekAngkaHuruf(evt) {
            var charCode = (evt.which) ? evt.which : event.keyCode
            if ((charCode >= 65 && charCode <= 90) || (charCode >= 97 && charCode <= 122) || (charCode >= 48 && charCode <=
                    57) || (charCode == 44 || charCode == 46) || charCode == 32 || charCode == 45 || charCode == 47 ||
                charCode == 64) {
                return true;
            } else {
                return false;
        ...
        function modal_sip(title, image) {
            ...
            if (file[1] == 'pdf' || file[1] == 'PDF') {
                content = '< src="{{ url('/') }}/uploads/file_berkas/' + image +
     ...
     */
        ...
        // Fungsi untuk memeriksa lampiran file
        function checkFilesRequired() {
            var centang = $('#invalidCheck2').is(':checked');
            var berkasPersyaratan = <?php echo json_encode($berkas_persyaratan); ?>;
            var filesNotAttached = [];

            if (centang) {
                var filesAttached = true;
                for (var i = 0; i < berkasPersyaratan.length; i++) {
                    var fileName = berkasPersyaratan[i].nama_variable.replace('/', '');
                    var fileInput = $('#' + fileName);
                    if (fileInput.length && fileInput[0].files.length === 0) {
                        filesAttached = false;
                        filesNotAttached.push(berkasPersyaratan[i].nama_jenis_persyaratan);
                    }
                }

                if (!filesAttached) {
                    var message = 'Mohon lampirkan file yang dibutuhkan sebelum mengajukan!';
                    if (filesNotAttached.length > 0) {
                        message += 'File yang belum terlampir:\n';
        message += filesNotAttached.join('\n');
                    }
                    swal({
                        title: 'Oops...',
                        text: message,
        ...
        function toggleJenisSarana(select) {
            var jenisSarana = select.value;
            if (jenisSarana == 3) {
                $('#jenis_sarana').hide();
                fillNamaTempatPraktik();
            } else {
                $('#jenis_sarana').show();
                $('#nama_tempat_praktik').val(''); // Mengosongkan kembali input jika jenis praktik bukan 3
            }
        }

        function fillNamaTempatPraktik() {
            // Cek apakah nama tempat praktik kosong, jika iya, isi dengan nama pengguna menggunakan JavaScript
            var namaTempatPraktik = $('#nama_tempat_praktik').val();
            if (namaTempatPraktik == "") {
                var namaPengguna = '<?= Auth::user()->name ?>';
                $('#nama_tempat_praktik').val(namaPengguna);
            }
        ...
        function add_waktu_praktik() {
            ...
            $('#table_waktu_praktik').append('<tr id="tr_waktu_praktik_' + waktu_praktik + '">' +
                '<td class="to_text" id="td_hari_' + waktu_praktik + '"><input id="input_hari_' + waktu_praktik +
                '" type="text" name="" class="form-control to_text" placeholder="Senin s.d Sabtu"></td>' +
                '<td class="to_text" id="td_jam_' + waktu_praktik + '">' +
                '<div class="row">' +
                '<div style="padding-right: 0px;" class="col-sm-10">' +
                '<input id="input_jam_' + waktu_praktik +
                '" type="text" name="" class="form-control to_text" placeholder="07.00 - 14.00">' +
                '</div>' +
                '<div style="padding-left: 0px;" class="col-sm-1">' +
                '<a href="javascript:void(0)" onclick="remove_waktu_praktik(\'tr_waktu_praktik_' + waktu_praktik +
                '\')" class="btn btn-warning"><i class="fa fa-eraser"></i></a>' +
                '</div>' +
                '</div>' +
                '</td>' +
        ...
        function add_input_waktu_praktik() {
            ...
            for (var i = 0; i < list_input.length; i++) {
                $('#td_hari_' + i).html('<input id="input_hari_' + i +
                    '" type="text" name="" class="form-control to_text" value="' + $('#td_hari_' + i).html() + '">');
                $('#td_jam_' + i).html('<div class="row">' +
                    '<div style="padding-right: 0px;" class="col-sm-10">' +
                    '<input id="input_jam_' + i + '" type="text" name="" class="form-control to_text" value="' + $(
                        '#td_jam_' + i).html() + '" placeholder="07.00 - 14.00">' +
                    '</div>' +
                    '<div style="padding-left: 0px;" class="col-sm-1">' +
                    '<a href="javascript:void(0)" onclick="remove_waktu_praktik(\'tr_waktu_praktik_' + i +
                    '\')" class="btn btn-warning"><i class="fa fa-eraser"></i></a>' +
                    '</div>' +
                    '</div>');
                waktu_praktik = waktu_praktik + 1;
            ...
            if (list_input.length > 0) {
                for (var i = 0; i < list_input.length; i++) {
                    $('#td_hari_' + i).html('<div class="row">' +
                        '<div style="margin-left: 30px;" class="col-sm-10">' +
                        '<input id="input_hari_' + i +
                        '" type="text" name="" class="form-control to_text_shift" value="' + String($('#td_hari_' + i)
                            .html()).replace(" : ", "") + '" placeholder="Senin s.d Sabtu">' +
                        '</div>' +
                        '<div style="padding-left: 0px;" class="col-sm-1">' +
                        '<a href="javascript:void(0)" onclick="remove_waktu_praktik_shift(\'tr_hari_shift_' + i +
                        '\')"  style="width: 39px;" class="btn btn-warning"><i class="fa fa-eraser"></i></a>' +
                        '</div>' +
                        '</div>');
                    ...
                    for (var j = 1; j < 7; j++) {
                        $('#td_jam_shift_' + i + '_' + j).html('<div class="row">' +
                            '<div style="padding-right: 0px;" class="col-sm-10">' +
                            '<input id="input_jam_shift_' + i + '_' + j +
                            '" type="text" name="" class="form-control to_text_shift" value="' + String($(
                                '#td_jam_shift_' + i + '_' + j).html()).replace(" : ", "") +
                            '" placeholder="07.00 - 14.00">' +
                            '</div>' +
                ...
                ($('.remove_add_shift')[$('.remove_add_shift').length - 1]).innerHTML =
                    '<a href="javascript:void(0)" onclick="add_waktu_praktik_shift_kolom(' + tmp_j + ', ' + tmp_i +
                    ')" style="margin-left: 16px;" class="btn btn-success"><i class="fa fa-plus-square"></i></a>';
            }
        }
        ...
        function add_waktu_praktik_shift_kolom(counter, pw) {
            ...
            $('#waktu_praktik_shift').append('<tr class="tr_hari_shift_' + pw + '">' +
                ...
                '<div class="row">' +
                '<div style="padding-right: 0px;" class="col-sm-10">' +
                '<input id="input_jam_shift_' + pw + '_' + counter +
                '" type="text" name="" class="form-control to_text_shift" placeholder="07.00 - 14.00">' +
                '</div>' +
                '<div class="remove_add_shift" style="padding: 0px;" class="col-sm-1">' +
                '<a href="javascript:void(0)" onclick="add_waktu_praktik_shift_kolom(' + (counter) + ', ' + pw +
                ')" style="margin-left: 16px;" class="btn btn-success"><i class="fa fa-plus-square"></i></a>' +
                '</div>' +
                '</div>' +
                '</td>' +
        ...
        function add_waktu_praktik_shift() {
            ...
            $('#waktu_praktik_shift').append('<tr class="tr_hari_shift_' + waktu_praktik + '">' +
                ...
                '<div class="row">' +
                '<div style="margin-left: 30px;" class="col-sm-10">' +
                '<input id="input_hari_' + waktu_praktik +
                '" type="text" name="" class="form-control to_text_shift" placeholder="Senin s.d Sabtu">' +
                '</div>' +
                '<div style="padding-left: 0px;" class="col-sm-1">' +
                '<a href="javascript:void(0)" onclick="remove_waktu_praktik_shift(\'tr_hari_shift_' + waktu_praktik +
                '\')"  style="width: 39px;" class="btn btn-warning"><i class="fa fa-eraser"></i></a>' +
                '</div>' +
                '</div>' +
                '</td>' +
                ...
                '<div class="row">' +
                '<div style="padding-right: 0px;" class="col-sm-10">' +
                '<input id="input_jam_shift_' + waktu_praktik +
                '_1" type="text" name="" class="form-control to_text_shift" placeholder="07.00 - 14.00">' +
                '</div>' +
                '<div class="remove_add_shift" style="padding: 0px;" class="col-sm-1">' +
                '<a href="javascript:void(0)" onclick="add_waktu_praktik_shift_kolom(1, \'' + waktu_praktik +
                '\')" style="margin-left: 16px;" class="btn btn-success"><i class="fa fa-plus-square"></i></a>' +
                '</div>' +
                '</div>' +
                '</td>' +
            ...
            if (fi.files.length > 0) {
                for (const i = 0; i <= fi.files.length - 1; i++) {
                    ...
                    if (file >= 2048) {
                        alert(
                            "File terlalu besar, file harus kurang dari 2MB");
                        document.getElementById('size2').innerHTML = '<b style="color:red;">' +
                            '* Anda harus upload ulang file';
                    } else {
        ...
        $('input[type=file]').on('change', function(e) {
            ...
            if (extValidation.indexOf(fileExt) < 0) {
                swal('Extensi File Tidak Valid !',
                    'Upload file bertipe .jpg, .jpeg atau .pdf, untuk dapat melakukan upload data...', 'warning'
                    )
                $(this).val("")
                return false;
            } else return true;
        ...
        $('.btn-simpan, .btn-draf').click(function(e) {
            ...
            if (!checkFilesRequired()) {
                return; // Return nothing when files are not attached
            }
            ...
            $.ajax({
                ...
                if (data.status == 'success') {
                    ...
                    if (data.message == "Preview") {
                        var content = '';
                        content = '<iframe src="{{ url('/') }}/upload/file_sip_salinan/' + data.data
                            .file_surat_sip_salinan + '" width="100%" height="950px"></iframe>';
                        $('#modal-body-view').html(content);
                        $('#id_surat_preview').val(data.data.id_surat);
                        $('#modal-body-preview').modal('show');
                        $('#btn-simpan-ajukan').html(
                            'Ajukan Permohonan <i class="fa fa-save fs-14 m-l-5"></i>').removeAttr(
                            'disabled');
                    } else {
                        window.location.href = "{{ url('/') }}/home/surat/list/" + data.data
                            .id_jenis_surat;
                    ...
                    $('.btn-simpan').html('Simpan <i class="fa fa-save fs-14 m-l-5"></i>').removeAttr(
                        'disabled');
                ...
                swal("MAAF !", "Mohon Lakukan Draft Dahulu !!", "warning");
                $('.btn-simpan').html('Simpan <i class="fa fa-save fs-14 m-l-5"></i>').removeAttr(
                    'disabled');
            });
        });
