          ...
          <div class="col-md-6 col-xs-12">
            ...
            <div class="col-md-6 col-xs-12">
              ...
              <div class="form-group" style="margin: 0px;">
                ...
                <input readonly type="text" name="profesi" class="form-control input-sm" value="{{$users->profesi}}">
              </div>
              <div class="clearfix" style="margin-bottom: 10px;"></div>
              ...
              <div class="form-group" style="margin: 0px;">
                ...
                <input type="text"name="keterangan_jenis_praktik" class="form-control input-sm " value="{{ $keterangan_jenis_praktik }}" style="text-transform:uppercase" placeholder="Tambahkan Jenis Praktik" onkeypress="return cekAngkaHuruf(event)">
              </div>
              <div class="clearfix" style="margin-bottom: 10px;"></div>
              @endif
               ...
               <?php if (count($list_ts_praktik) > 1){ ?>
                <div class="form-group" style="margin: 0px;">
                  <label>Jenis Praktik<span class="colorRed">*</span></label>
                  <select name="jenis_praktik" id="jenis_praktik" class="form-control" onchange="toggleJenisSarana(this)">
              ...
              <div class="form-group" id="jenis_sarana" style="margin: 0px; <?= ($id_jenis_praktik == 3) ? 'display: none;' : '' ?>">
            ...
            <div class="clearfix" style="margin-bottom: 10px;"></div>
             ...
             <!-- <div class="form-group" style="margin: 0px;">
                ...
                <input type="text"name="nomor_op" class="form-control input-sm " value="<?php if ($perpanjangan != '/perpanjangan'){ echo $nomor_op; } ?>" style="text-transform:uppercase" onkeypress="return cekAngkaHuruf(event)">
              </div>
              <div class="clearfix" style="margin-bottom: 10px;"></div>-->

              <div class="form-group" style="margin: 0px;">
                <label>Nama Tempat Praktik (Khusus Praktek Mandiri diisi PRAKTEK PERSEORANGAN)<span class="colorRed">*</span></label>
                <input type="text" name="nama_tempat_praktik" id="nama_tempat_praktik" class="form-control input-sm" value="<?=isset($nama_tempat_praktik) ? $nama_tempat_praktik : '' ?>" style="text-transform:uppercase" onkeypress="return cekAngkaHuruf(event)">
             </div>
             <div class="clearfix" style="margin-bottom: 10px;"></div>
  ...
  function requireder(){
   var centang = $('#invalidCheck2').is(':checked');
    if(centang==true){
       ...
       $('input[name=profesi]').attr('required','required');
