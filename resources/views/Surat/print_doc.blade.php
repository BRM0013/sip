...
<body>
    <?php
    $nama_pakai = "Surat_Keterangan_".$nama."_".date('Y-m-d');
    ?>
    ...
    <script>
        function Export2Doc(element, filename){
            var preHtml, postHtml, html, link, blob, url, css;
             ...
             'table#drg{margin-right: 50px;}' +
             'table#alamat_lengkap{margin-right: 50px;}td#alamat{margin-right:100px;}' +
             'table#kode_qr td{margin-right: 100px;}' +
             'table#logo_dinkes td{border-collapse:collapse;margin-top:60px; margin-right: 1000px;}' +
             'div#water img#gagun{display:none;}' +
             '</style>'
           );
