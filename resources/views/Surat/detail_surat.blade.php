                    ...
                    <div class="panel-body">
                        ...
                        <div class='col-lg-8 col-md-7 col-sm-12 col-xs-12'>
                            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                             ...
                             <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                                <div class="form-group m-t-0 m-b-25">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-6" id='modal-label'>Jenis Pengajuan</label>: {{$surat->jenis_pengajuan}}
                                </div>
                            </div>
                            ...
                            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                             ...
                             <!--<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                                <div class="form-group m-t-0 m-b-25">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-6" id='modal-label'>Perolehan STR</label>: {{$surat->perolehan_str}}
                                </div>
                            </div>-->
                            ...
                            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class="form-group m-t-0 m-b-25">
                                    ...
                                    <label class="control-label col-md-4 col-sm-4 col-xs-6" id='modal-label'>Profesi</label>: {{$surat->profesi}}
                ...
                <?php if (isset($surat->file_surat_sip_salinan)  && Auth::getUser()->id_level_user != 2): ?>
                    ...
                    <section class="panel panel-default m-b-0">
                        ...
                        <div class="panel-body">
                            ...
                            <label style="margin-top: 15px;">DATA PERMOHONAN : </label>
                            ...
                            <table border="1px" style="padding: 10px; width: 100%; border-collapse: collapse;">
                                ...
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>SIP KE :</td><td style="text-align: left">{{$surat->sip_ke}}</td>
                                </tr>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Jenis Pengajuan :</td><td style="text-align: left">{{$surat->jenis_pengajuan}}</td>
                                </tr>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Tanggal Pengajuan :</td><td style="text-align: left">{{ App\Http\Libraries\Formatters::tgl_indo($surat->tanggal_pengajuan,'') }} {{ date('H:i:s', strtotime($surat->tanggal_pengajuan))}}</td>
                                </tr>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Jenis Praktik :</td><td style="text-align: left">{{$surat->jenis_praktik->nama_jenis_praktik}}</td>
                                </tr>
                                <td><?php echo $no++; ?></td>
                                <td>Jenis Sarana :</td><td style="text-align: left">{{$surat->jenis_sarana->nama_sarana}}</td>
                                </tr>
                                <td><?php echo $no++; ?></td>
                                <td>Nomor STR :</td><td style="text-align: left">{{$surat->nomor_str}}</td>
                                </tr>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Perolehan STR :</td><td style="text-align: left">{{$surat->perolehan_str}}</td>
                                </tr>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Profesi :</td><td style="text-align: left">{{$surat->profesi}}</td>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Tanggal Belaku STR :</td><td style="text-align: left">{{ App\Http\Libraries\Formatters::tgl_indo($surat->tanggal_berlaku_str,'') }}</td>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Nomor Rekomendasi OP :</td><td style="text-align: left">{{$surat->nomor_op}}</td>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Nama Tempat Praktik :</td><td style="text-align: left">{{$surat->nama_tempat_praktik}}</td>
                                <tr>
                                <td><?php echo $no++; ?></td>
                                <td>Alamat Tempat Praktik:</td><td style="text-align: left">{{$surat->alamat_tempat_praktik}}</td>
                                <tr>
                                </tr>
