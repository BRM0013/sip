<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Permohonan Surat Izin Praktik</div>
                            ...
                            <div class="col-md-6">
                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <label for="email" class="col-md-4 col-form-label text-md-right">
                                            <br>
                                            Mohon maaf kepada bapak atau ibu, kami tidak dapat memberikan izin praktik {{ $sip }}, silahkan lakukan perbaikan sesuai dengan keterangan beriku : 
                                            <br>
                                            {{ $keterngan }}
                                            <br>
                                        </label>
