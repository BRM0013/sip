...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Semua Surat Izin Praktek</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Master Data</a></li>
      <li class="active"> Semua Surat Izin Praktek</li>
    </ol>
  </section>
          ...
          <div class="col-md-12" style="margin-bottom: 10px;">
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12 form-inline main-layer panelSearch p-10">
              ...
              @endif
              @else
              @if(Auth::getUser()->id_level_user != 1 && Auth::getUser()->id_level_user != 3 && Auth::getUser()->id_level_user != 4 && Auth::getUser()->id_level_user != 5 && Auth::getUser()->id_level_user != 8 && Auth::getUser()->id_level_user != 9)
              ...
              <?php if (Auth::getUser()->id_level_user != 2): ?>
                ...
                <?php endif ?>
                <div class="col-sm-3">
                  <label>Filter SIP</label>
                  <br>
                  <select class="form-control"  id="jenis_surat" name="jenis_surat" onchange="get_load(this.value)">
                    <option value="Semua">Semua</option>
  ...
  <script type="text/javascript">
    ...
    function get_load(filter) {        
        ...
        if(filter == 'Tanggal Terbit'){
          ...
          datagrid = $("#datagrid").datagrid({
              url                     : '{{ route("datagrid_surat-all") }}?id='+$('#jenis_surat').val()+'&filter='+$('#filter').val()+'&praktik='+$('#jenis_praktik').val()+'&tanggal_terbit='+$('input[name=tanggal_terbit]').val(),
   ...
   function menu(rowData,rowIndex){
    ...
    if (rowData.file_surat_sip_asli != null && {{ Auth::getUser()->id_level_user }} != 2 ) {
        html += '<li><a href="javascript:void(0)" onclick="perbarui_surat(`'+rowData.id_surat+'`)"><i class="fa fa-refresh"></i> Perbarui Berkas</a></li>';
    ...
    if (rowData.file_surat_sip_salinan != null) {
    ...
    if (rowData.file_surat_pencabutan_sip_asli != null && {{ Auth::getUser()->id_level_user }} != 2) {
      html += '<li><a target="_blank" href="{{ url("/") }}/upload/file_sip_asli/'+rowData.file_surat_pencabutan_sip_asli+'"><i class="fa fa-file-text-o"></i> Berkas Pencabutan Asli</a></li>';
    }

    if (rowData.file_surat_pencabutan_sip_salinan != null) {
    ...
    if ((rowData.disetujui_admin == 'Menunggu' || rowData.status_aktif == 'Tolak') || {{ Auth::getUser()->id_level_user }} != 2 && {{ Auth::getUser()->id_level_user }} != 9) {
      html += '<li><a href="{{ url("/") }}/home/surat/edit/'+rowData.id_surat+' "><i class="fa fa-pencil"></i> Edit Permohonan</a></li>';
    }
    ...
    }else if((rowData.status_aktif == 'Aktif' || rowData.status_aktif == 'Dijadwalkan Tanggal' || rowData.status_aktif == 'Sudah Diambil') && ({{Auth::getUser()->id_level_user}} != 8)){
  ...
  function perbarui_surat(id_surat) {
    // var update = 'true';
    $.post("{{route('perbarui_surat')}}", {id_surat:id_surat}).done((data) => {
      if (data.status == 'success') {
        swal('Success',data.message,'success')
      }
    })
